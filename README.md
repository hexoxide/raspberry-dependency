...
It is also necessary to have sudo and git installed. (Also make sure to get a copy of the repo through git clone.) To install the dependencies, use these commands:
```
su root
apt install sudo
apt install git
